  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved box as @box" do
        ...
        post :create, {:box => { "bees" => "invalid value" }}, valid_session
        assigns(:box).should be_a_new(Box)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested box" do
        ...
        Box.any_instance.should_receive(:update_attributes).with({ "bees" => "1" })
        put :update, {:id => box.to_param, :box => { "bees" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the box as @box" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Box.any_instance.stub(:save).and_return(false)
        put :update, {:id => box.to_param, :box => { "bees" => "invalid value" }}, valid_session
        assigns(:box).should eq(box)
      end
